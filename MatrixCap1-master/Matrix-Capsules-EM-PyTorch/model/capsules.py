...
class CapsNet(nn.Module):
    ...
    def __init__(self, A=32, B=32, C=32, D=32, E=10, K=3, P=4, iters=3):
        ...
        self.resnextb1 = ResNextB(in_channels=1, out_channels=A, stride=1, cardinality=2, base_width=32, widen_factor=4)
        self.primary_caps = PrimaryCaps(A, B, 1, P, stride=1)
        self.conv_caps1 = ConvCaps(B, C, K, P, stride=1, iters=iters)
        self.conv_caps2 = ConvCaps(C, D, K, P, stride=1, iters=iters)
        self.conv_caps3 = ConvCaps(D, 32, K, P, stride=1, iters=iters)
        self.conv_caps4 = ConvCaps(32, 64, K, P, stride=1, iters=iters)
        self.conv_caps5 = ConvCaps(64, 128, K, P, stride=1, iters=iters)
        self.conv_caps6 = ConvCaps(128, 256, K, P, stride=1, iters=iters)
...
"""
        ...
        """
        self.class_caps = ConvCaps(256, E, 1, P, stride=1, iters=iters,
